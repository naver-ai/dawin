...
task_vectors = [
    TaskVector(pretrained_checkpoint, '../checkpoints/'+model+'/'+dataset_name+'/finetuned.pt') for dataset_name in exam_datasets
]
...
image_encoder = task_vector_sum.apply_to(pretrained_checkpoint, scaling_coef=scaling_coef_,pt_scaling_coef=ptcoef)
