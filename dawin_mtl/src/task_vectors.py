...
class TaskVector():
    ...
    def apply_to(self, pretrained_checkpoint, scaling_coef=1.0, pt_scaling_coef=1.0):
        ...
        with torch.no_grad():
            ...
            for key in pretrained_state_dict:
                if key not in self.vector:
                    ...
                    continue
                new_state_dict[key] = pt_scaling_coef * pretrained_state_dict[key] + scaling_coef * self.vector[key]
